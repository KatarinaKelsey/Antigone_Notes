...
![The figure shows a woman's mouth, slightly open, with a head tilted backwards. Image is monochrome, with ochre tint.](images/01-03-img.png)

![The figure shows a woman's mouth. Image is monochrome, with ochre tint.](images/01-04-img.png)

![The figure shows a woman's mouth (frontal). Image is monochrome, with ochre tint.](images/01-05-img.png)

![The figure shows a woman's mouth closed, with a head leaning slightly forward. Image is monochrome, with ochre tint.](images/01-06-img.png)

![The figure shows a woman's mouth (from nose down to chin). Image is monochrome, with ochre tint.](images/01-07-img.png)

![The figure shows a woman's  mouth. Image is monochrome, with ochre tint.](images/01-08-img.png)

![The figure shows a woman's  mouth (nose to top of chin). Image is monochrome, with ochre tint.](images/01-09-img.png)

![The figure shows four pairs of men's legs, from the sole to the knee, in a relaxed third ballet position, and a pair of women's legs, from sole to tight, crouching. They are all wearing ballet shoes and attire. From left to right, the three men are standing in a line, diagonally, one is stepping forward and the woman on the far right, seen from the side, is squatting. Image is monochrome, with ochre tint.](images/01-10-img.png)

![From right to left, the figure shows three pairs of men's legs, visible from the sole to the knee, standing in a line, diagonally, in a relaxed third ballet position, and on the left a woman, seen from the side, squatting, with dress hanging behind. They are all wearing ballet shoes and attire. Drapery is hanging behind them. Image is monochrome, with ochre tint.](images/01-11-img.png)
...
![The figure shows a woman's mouth, slightly open. Image is monochrome, with ochre tint. Image's right corners are cropped.](images/02-03-img.png)
...
![The figure shows a collage of two images depicting at the bottom half the original scan(images/01-03-img.png) of woman's mouth, slightly open, and at the top part the original scan (images/01-11-img.png) of a woman seen from the side, squatting, with dress hanging behind and reaching the woman's mouth below. A horizontal line divides the two images/collaged together, breaking the composition at one third from the bottom. Image is monochrome, with ochre tint.](images/02-08-img.png)
...
![The figure shows a cropped segment of the original scan (images/01-11-img.png) of a pair of men's legs, visible from the sole to the mid calf, in a relaxed third ballet position. A dark line runs vertically in the front middle of the left leg. The man is wearing ballet shoes and attire. Drapery is hanging behind. Image is monochrome, with ochre tint.](images/02-11-img.png)
right Rightly right
...
![The figure shows a cropped segment of the original scan (images/01-11-img.png) of a pair of men's legs, visible from the sole to the knee, in a relaxed third ballet position. A dark line runs vertically in the front middle of the left leg. The man is wearing ballet shoes and attire. Drapery is hanging behind. Overlaid drapery bleeds out of the bottom left side of the image. Image is monochrome, with ochre tint.](images/03-10-img.png)
...
![The figure shows the original scan (images/01-05-img.png) of a woman's mouth (frontal), a piece of silicone hanging from underneath it, and a found images/of a woman’s mouth, with ectoplasm, from a séance. Image is monochrome, with ochre tint.](images/04-09-img.png)
