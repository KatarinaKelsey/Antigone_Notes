...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">01-04-img.png</xsl:variable>
    <xsl:variable name="DocFileName">01-04-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">204</xsl:variable>
    <xsl:variable name="ScaledImageHeight">110</xsl:variable>
    <xsl:variable name="ZoomImageWidth">204</xsl:variable>
    <xsl:variable name="ZoomImageHeight">110</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">01-04-img_wv_01-04-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">01-04-img_wv_zoom_01-04-img.jpg</xsl:variable>
