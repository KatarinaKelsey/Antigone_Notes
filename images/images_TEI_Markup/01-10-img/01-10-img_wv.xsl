...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">01-10-img.png</xsl:variable>
    <xsl:variable name="DocFileName">01-10-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">202</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1004</xsl:variable>
    <xsl:variable name="ZoomImageHeight">254</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.796813</xsl:variable>
    <xsl:variable name="ScaledImageFileName">01-10-img_wv_01-10-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">01-10-img_wv_zoom_01-10-img.jpg</xsl:variable>
