...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">03-10-img.png</xsl:variable>
    <xsl:variable name="DocFileName">03-10-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">449</xsl:variable>
    <xsl:variable name="ScaledImageHeight">388</xsl:variable>
    <xsl:variable name="ZoomImageWidth">449</xsl:variable>
    <xsl:variable name="ZoomImageHeight">388</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">03-10-img_wv_03-10-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">03-10-img_wv_zoom_03-10-img.jpg</xsl:variable>
