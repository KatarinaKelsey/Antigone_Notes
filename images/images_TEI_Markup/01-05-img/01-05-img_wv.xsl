...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">01-05-img.png</xsl:variable>
    <xsl:variable name="DocFileName">01-05-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">237</xsl:variable>
    <xsl:variable name="ScaledImageHeight">119</xsl:variable>
    <xsl:variable name="ZoomImageWidth">237</xsl:variable>
    <xsl:variable name="ZoomImageHeight">119</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">01-05-img_wv_01-05-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">01-05-img_wv_zoom_01-05-img.jpg</xsl:variable>
