...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">04-05-img.png</xsl:variable>
    <xsl:variable name="DocFileName">04-05-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">1015</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1387</xsl:variable>
    <xsl:variable name="ZoomImageHeight">1759</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.576784</xsl:variable>
    <xsl:variable name="ScaledImageFileName">04-05-img_wv_04-05-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">04-05-img_wv_zoom_04-05-img.jpg</xsl:variable>
