...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">04-10-img.png</xsl:variable>
    <xsl:variable name="DocFileName">04-10-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">472</xsl:variable>
    <xsl:variable name="ScaledImageHeight">648</xsl:variable>
    <xsl:variable name="ZoomImageWidth">472</xsl:variable>
    <xsl:variable name="ZoomImageHeight">648</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">04-10-img_wv_04-10-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">04-10-img_wv_zoom_04-10-img.jpg</xsl:variable>
