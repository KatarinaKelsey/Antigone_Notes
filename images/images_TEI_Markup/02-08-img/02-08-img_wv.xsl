...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">02-08-img.png</xsl:variable>
    <xsl:variable name="DocFileName">02-08-img</xsl:variable>
    <xsl:variable name="ScaledImageWidth">184</xsl:variable>
    <xsl:variable name="ScaledImageHeight">201</xsl:variable>
    <xsl:variable name="ZoomImageWidth">184</xsl:variable>
    <xsl:variable name="ZoomImageHeight">201</xsl:variable>
    <xsl:variable name="ImageScaleFactor">1</xsl:variable>
    <xsl:variable name="ScaledImageFileName">02-08-img_wv_02-08-img.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">02-08-img_wv_zoom_02-08-img.jpg</xsl:variable>
